...
const attackType1Hitbox = new HitboxedAttackArea(
  { x: -2, y: -2, z: -1 },
  { x: 2, y: 0.5, z: 3 },
);
const attackType2Hitbox = new HitboxedAttackArea(
  { x: -2, y: -2, z: -1 },
  { x: 2, y: 3, z: 3 },
);
const attackType3Hitbox = new HitboxedAttackArea(
  { x: -2, y: -2, z: -1 },
  { x: 2, y: 3, z: 3 },
);
const attackType4Hitbox = new HitboxedAttackArea(
  { x: -1.5, y: -2, z: -1 },
  { x: 1.5, y: 0.25, z: 3 },
);
