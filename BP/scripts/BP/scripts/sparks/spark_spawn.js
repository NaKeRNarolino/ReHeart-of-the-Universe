...
mc.world.afterEvents.entityDie.subscribe((data) => {
    ...
    summonSparks(data.deadEntity.dimension, location, Math.max(3, Math.floor(Math.random() * hp)), 2, grabSparks);
});
function grabSparks(value, player) {
